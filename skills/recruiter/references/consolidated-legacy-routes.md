...
|---|---|
| candidate-target-search | `modules/candidate-match-engine`, especially `modules/candidate-match-engine/references/reverse-match-edge-rules.md`, and `modules/web-sourcing` |
| company-target-search | `modules/web-sourcing`, `modules/candidate-match-engine` |
...
| sourcing-agents | `modules/sourcing`, `modules/web-sourcing`, and candidate-match-engine; Loxo scripts/templates excluded |
