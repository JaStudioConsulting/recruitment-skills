...
Included: the recruiter router, its 23 internal modules, policies, capability and host/tool/plugin/workflow manifests, deterministic sanitized builders and assets, synthetic fixtures, host compatibility documentation, and ADR 0004 as the governing historical decision record.
